...
async changeDetails() {
    ...
    const response = await axios.post('https://codebranch.me/api/changedetails', this.accountDetails, {headers: headers, withCredentials: true})
    this.changed = true
    },
    ...
    const response = await axios.post('https://codebranch.me/api/changePassword', this.accountDetails, {headers: headers, withCredentials: true})
    this.changed2 = true
